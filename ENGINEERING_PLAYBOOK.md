...
- Static portfolio data (`/about`, `/projects`, `/stack`): P95 < 100ms *(Under low traffic, transient spikes to 150-500ms are expected — Koyeb free-tier hypervisor jitter amplified by histogram bucket interpolation at low sample counts; see SLO_DEFINITIONS.md §1)*
