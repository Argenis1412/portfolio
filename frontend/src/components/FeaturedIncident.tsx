            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="bg-red-500/10 text-red-400 text-[10px] font-mono px-2 py-0.5 rounded border border-red-500/20 font-bold uppercase tracking-widest">
                  {t('incident.0042.badge')}
                </span>
                <span className="text-app-muted font-mono text-[10px]">{t('incident.0042.id')}</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
                {t('incident.0042.title')}
              </h2>
            </div>
            
            <div className="flex gap-4 border-l border-app-border/40 pl-4">
              <div className="text-center">
                <div className="text-xs font-mono text-app-muted uppercase">{t('incident.0042.mttr')}</div>
                <div className="text-lg font-bold text-emerald-400">14m</div>
              </div>
              <div className="text-center">
                <div className="text-xs font-mono text-app-muted uppercase">{t('incident.0042.impact_label')}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 space-y-6">
              <div className="space-y-4">
                <h3 className="text-xs font-mono font-bold text-app-primary uppercase tracking-widest">{t('incident.0042.timeline_title')}</h3>
                <div className="relative border-l border-app-border/40 pl-4 space-y-6">
                  <div className="relative">
                    ...
                    <div className="text-xs font-bold text-app-text mt-1">{t('incident.0042.t1_desc')}</div>
                  </div>
                  <div className="relative">
                    ...
                    <div className="text-xs font-bold text-app-text mt-1">{t('incident.0042.t2_desc')}</div>
                  </div>
                  <div className="relative">
                    ...
                    <div className="text-xs font-bold text-app-text mt-1">{t('incident.0042.t3_desc')}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 space-y-6">
              <div>
                <h3 className="text-xs font-mono font-bold text-app-primary uppercase tracking-widest mb-3">{t('incident.0042.postmortem_title')}</h3>
                <p className="text-sm text-app-muted leading-relaxed">
                  {t('incident.0042.postmortem_desc')}
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-app-surface/40 rounded-xl border border-app-border/40 p-4">
                  <div className="text-[10px] font-mono text-app-primary mb-2 uppercase">{t('incident.0042.lesson_title')}</div>
                  <p className="text-[11px] text-app-muted italic font-serif">
                    {t('incident.0042.lesson_desc')}
                  </p>
                </div>
                <div className="bg-app-surface/40 rounded-xl border border-app-border/40 p-4">
                  <div className="text-[10px] font-mono text-app-primary mb-2 uppercase">{t('incident.0042.debt_title')}</div>
                  <ul className="text-[11px] text-app-muted space-y-1 list-disc pl-3">
                    <li>{t('incident.0042.debt_item1')}</li>
                    <li>{t('incident.0042.debt_item2')}</li>
                  </ul>
                </div>
              </div>
            </div>
