...
class ResumoMetricas(BaseModel):
    ...
    error_rate_status: str = Field(..., examples=["stable"], description="Status da taxa de erro")
    ...
    window: str = Field(..., examples=["last_24h"], description="Janela de tempo das métricas")
