...
$commands = @{
    "dev"         = "Start-Process powershell -ArgumentList '-NoExit', '-Command', 'cd backend; .venv\Scripts\activate; python -m uvicorn app.principal:app --reload'; cd frontend; npm run dev"
    "dev-back"    = "cd backend; .venv\Scripts\activate; python -m uvicorn app.principal:app --reload"
